...
(function(){
  ...
  function distribute(total,count){const n=Math.max(1,count),base=Math.floor(total/n),extra=total%n;return Array.from({length:n},(_,i)=>Math.max(1,base+(i<extra?1:0)))}
